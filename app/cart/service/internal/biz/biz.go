...
var ProviderSet = wire.NewSet(NewCartUseCase, NewDiscovery, NewProdServiceClient)

func NewProdServiceClient(r registry.Discovery, ac *conf.JWT) v1.ProdServiceClient {
