...
//func NewHTTPServer(c *conf.Server, jwtc *conf.JWT, svc *service.CartServiceImpl, logger log.Logger) *http.Server {
...
//    return srv
//}
//func InitGlobalValue(c *conf.Server, jwtc *conf.JWT, svc *service.CartServiceImpl) {
