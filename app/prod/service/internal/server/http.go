...
//func NewHTTPServer(c *conf.Server, jwtc *conf.JWT, svc *service.ProdServiceImpl, logger log.Logger) *http.Server {
...
//    v12.RegisterCartServiceHTTPServer(srv, svc)
//    return srv
//}
//func InitGlobalValue(c *conf.Server, jwtc *conf.JWT, svc *service.ProdServiceImpl) {
